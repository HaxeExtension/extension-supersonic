...
#import "MBRXMoatAdEvent.h"

@interface MBRXMoatVideoTracker : MBRXMoatBootstrap

+ (MBRXMoatVideoTracker *)trackerWithPartnerCode:(NSString *)partnerCode;
...
- (void) dispatchEvent:(MBRXMoatAdEvent *)event;
