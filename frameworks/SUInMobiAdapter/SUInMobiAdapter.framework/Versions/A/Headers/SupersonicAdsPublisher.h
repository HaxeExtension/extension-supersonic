...
- (void)supersonicISLoadFailedWithError:(NSError *)error;
...
- (void)ssaInitOfferWallFailedWithError:(NSError *)error;
...
// Offer Wall
/*-----------------------------------------------*/
- (void)initOfferWallWithApplicationKey:(NSString *)applicationKey userId:(NSString *)userId delegate:(id<SSAOfferWallDelegate>)delegate additionalParameters:(NSDictionary *)parameters;
- (void)showOfferWallWithExtraParam:(NSDictionary *)parameters;
- (void)showOfferWallWithExtraParam:(NSDictionary *)parameters withViewController:(UIViewController*)viewController;
