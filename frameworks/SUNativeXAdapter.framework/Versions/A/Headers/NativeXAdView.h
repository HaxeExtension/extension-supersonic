...
/**
 *  Called right after the ad officially applies its impression event
 *  @param placementName    - the placement name string of the Ad that has its impresison event sent
 */
- (void)nativeXAdViewAdImpressionConfirmed:(NSString*) placementName;
